...
contract codex {
  ...
  function musical_instrument() public pure returns (ITools.Tools memory result) {
    ...
    result.description = "A common instrument grants a +0 circumstance bonus on Perform checks involving its use.";
    result.description = "Common instruments can be used for any kind of performance. Without them, you have to use improvised instruments (-2 penalty on Perform checks).";
