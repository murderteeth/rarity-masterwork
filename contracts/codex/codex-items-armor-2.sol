...
contract codex {
  ...
  function leather() public pure returns (IArmor.Armor memory armor) {
    ...
    armor.description = "Leather armor is made up of multiple overlapping pieces of leather, boiled to increase their natural toughness and then deliberately stitched together. Although not as sturdy as metal armor, the flexibility it allows wearers makes it among the most widely used types of armor.";
  }
  ...
  function shield_light_wooden() public pure returns (IArmor.Armor memory armor) {
    ...
    armor.penalty = -1;
    armor.spell_failure = 5;
    armor.description = "Wooden and steel shields offer the same basic protection, though they respond differently to special attacks";
  }

  function shield_light_steel() public pure returns (IArmor.Armor memory armor) {
    armor.id = 15;
  ...
  function shield_heavy_wooden() public pure returns (IArmor.Armor memory armor) {
    armor.id = 16;
  ...
  function shield_heavy_steel() public pure returns (IArmor.Armor memory armor) {
    armor.id = 17;
  ...
  function shield_tower() public pure returns (IArmor.Armor memory armor) {
    ...
    armor.description = "This massive wooden shield is nearly as tall as you are. In most situations, it provides the indicated shield bonus to your AC. However, you can instead use it as total cover, though you must give up your attacks to do so. The shield does not, however, provide cover against targeted spells; a spellcaster can cast a spell on you by targeting the shield you are holding. You cannot bash with a tower shield, nor can you use your shield hand for anything else.";
  }
}
