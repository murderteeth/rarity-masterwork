...
import { equipmentType, getDamageType, randomId, unpackAttacks } from '../../test/util'
import { fakeAttributes, fakeCommonCraftingWrapper, fakeCraft, fakeFeats, fakeFullPlateArmor, fakeGreatsword, fakeHeavyCrossbow, fakeHeavyWoodShield, fakeLeatherArmor, fakeLongsword, fakeMasterwork, fakeRandom, fakeRarity, fakeSkills, fakeSummoner } from '../../test/util/fakes'
...
import { skills } from '../../test/util/skills'
...
import { armors, weapons } from '../../test/util/equipment'
